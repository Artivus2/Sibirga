<template>
  ...
  <div :class="maxWindowClass" class="uchet-agk">
    ...
    <div style="display: flex;">
      <div style="width: 510px;">
        <div :class="maxWindowClass" class="main-content sidebar">
  ...
  />
    ...
    <!-- <mines-dropdown
      :options="reportsList"
      :default="reportsList[0].title"
      class="select"
      :tabindex="selectedReportId"
      @selectedReport="oninput"
...
export default {
  name: "uchetagz",
    ...
    oninput(selectedMineId) {
      ...
      this.filteredList = this.dataagz.filter((e) => e.mine === selectedMineId).map((e) => 
      {
        return {
    ...
    filterById(selectedSensorId) {
      this.filteredList = this.dataagz.filter((e) => e.id == selectedSensorId).map((e) => 
      {
        return {
        id: e.id, title: e.title, zavod_id: e.zavod_id, madate: e.madate, location: e.location, mine: e.mine
      }
    ...
    addSensor(selectedSensorId) {
      console.log("выбран: " + selectedSensorId.id) 
    },
    // onmine(MineId) {
