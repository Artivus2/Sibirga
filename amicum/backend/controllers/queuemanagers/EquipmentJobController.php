 ...
 * Класс/Испольнитель очереди оборудований
 * @package backend\controllers\queuemanagers
 */
class EquipmentJobController extends BaseObject implements \yii\queue\JobInterface
{
	...
	public function execute($queue)
	{
		...
		QueueLog::AddLog($this->controller, $this->method, $this->data, $duration, $result, $errors, 'equipment');// записываем лог в БД
	}
}