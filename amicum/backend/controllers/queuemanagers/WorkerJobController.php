 ...
 * Класс/Испольнитель очереди работников
 * @package backend\controllers\queuemanagers
 */
class WorkerJobController extends BaseObject implements \yii\queue\JobInterface
{
	...
	public function execute($queue)
	{
		...
		QueueLog::AddLog($this->controller, $this->method, $this->data, $duration, $result, $errors, 'worker');// записываем лог в БД
