<?php
if (!defined('SERIAL_DEVICE_NOTSET')) define('SERIAL_DEVICE_NOTSET', 0);
if (!defined('SERIAL_DEVICE_SET')) define('SERIAL_DEVICE_SET', 1);
if (!defined('SERIAL_DEVICE_OPENED')) define('SERIAL_DEVICE_OPENED', 2);
