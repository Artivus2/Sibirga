...
use frontend\controllers\UserAutorizationController;
use Throwable;
use Yii;
...
class ReadManagerAmicumController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        try {
            ...
            $namespace = 'backend\controllers\\';                                                                       // пространство имен Yii2
        ...
        Yii::$app->response->format = Response::FORMAT_JSON;
        Yii::$app->response->data = array('Items' => $result, 'status' => $status, 'errors' => $errors, 'warnings' => $warnings, 'debug' => $debug, 'debug_data' => $debug_data);
    }
}
