...
$files = scandir($_SERVER['DOCUMENT_ROOT']. "/web/risk_assessment_and_management_system_prod");
...
foreach($files AS $file)
{
    ...
    {
        $this->registerJsFile('/risk_assessment_and_management_system_prod/'.$file . '?ver=' . $version, ['depends' => [AppAsset::className()],'position' => View::POS_END]);
    }
}
