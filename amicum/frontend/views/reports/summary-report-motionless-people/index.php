...
$this->registerCssFile('/css/summary-motionless-people.css', ['depends' => [\frontend\assets\AppAsset::className()]]);
$this->registerJsFile('/js/jquery.cookie.js', ['depends' => [\frontend\assets\AppAsset::className()], 'position' => View::POS_END]);
$this->registerJsFile('/js/summary-motionless-people.js', ['depends' => [\frontend\assets\AppAsset::className()], 'position' => View::POS_END]);
...
$this->title = 'Персонал без движения, события';
?>
<style>
    #menuL9 {
...
<!--Прелоадер-->
<p id="captionPrint">Нахождение персонала без движения (события)</p>
    ...
    <div class="col-xs-10 right-side" id="containerRight">
        ...
        <div class="content-header">
            <div class="left-side-header">
                ...
                <!-- Кнопка печати -->
                <a href="/reports/print-page" target="_blank">
                    <button class="content-header-button btn-icn-2" style="padding-left: 33px;"
                            title="Предпросмотр документа" id="printViewButton">Предпросмотр
                    </button>
                </a>
                ...
                <button class="content-header-button btn-icn-3" style="padding-left: 33px; display: none;"
                        title="Построение графика" id="chartViewButton">График
                </button>
                <!-- Контейнер поиска -->
                <div id="searchContainer" class="search-container col-xs-12">
                    <div class="col-xs-10 search-container-left">
                        <!-- Блок фильтрации -->
                        <button class="in-search-button filter-button icon-add-current-btn noneClosed" id="filterButton"
...
<!--                                <div>Подразделение</div>-->
                            ...
                            </span><span id="closed-department">×</span>
                        </div>
...
<!--                                <div>Местоположение</div>-->
                        ...
                        <!-- Сам поиск -->
                        <input type="search" placeholder="Введите поисковой запрос..." class="search" id="search"
                    ...
                    <div class="col-xs-2 search-container-right">
                        ...
                        <!-- Кнопка поиска -->
                        <button class="in-search-button search-button icon-filter-search-btn"
                                id="searchButtonBlue"></button>
                    </div>
                </div>
        ...
        <div class="col-xs-12 table-body">
            ...
            <div class="content-body col-xs-10" style="width: 100%;">
                ...
                <div class="graphic-container" id="graphContainer">
                    <div class="graphic-left-side">
                        <div class="graphic-table-header">
                            <div class="header_row">Количество событий</div>
                            <div class="header_row">ФИО</div>
                        </div>
                        <div class="graphic-table-body"></div>
                    </div>
                    <div class="graphic-right-side">
                        <div class="graphic-pie-chart">
                ...
                <div class="body-th" id="bodyTH" style="height: auto;">
                    <div style="width: 100%; display: flex;">
                        <div class="body-th-item sort-field" data-field="date_work" style="width: 7%;"><span>Дата</span><span
                                    class="glyphicon"></span></div>
                        <div class="body-th-item sort-field" data-field="smena" style="width: 9%;">
                            <span>Смена</span><span class="glyphicon"></span></div>
                        <div class="body-th-item sort-field" data-field="tabel_number"
                             style="width: 8%; line-height: 1;"><span>Табельный номер</span><span
                                    class="glyphicon"></span></div>
                        <div class="body-th-item sort-field" data-field="FIO" style="width: 24%;"><span>ФИО</span><span
                                    class="glyphicon"></span></div>
                        <div class="body-th-item sort-field" data-field="title_department" style="width: 23%;"><span>Подразделение</span><span
                                    class="glyphicon"></span></div>
                        <div class="body-th-item sort-field" data-field="title_place" style="width: 19%;"><span>Местоположение</span><span
                                    class="glyphicon"></span></div>
                        <div class="body-th-item sort-field" data-field="count" style="width: 10%; line-height: 1;">
                            <span>Количество событий за смену</span><span class="glyphicon"></span></div>
                    </div>
                ...
                <div class="content-table" id="body-table">
                    <!--                    <div class="row-table">-->
                    <!--                    <div class="number-tabel" style="width: 6%;"></div>-->
                    <!--                    <div class="name" style="width: 20%;"></div>-->
                    <!--                    <div class="unit" style="width: 25%;"></div>-->
                    <!--                    <div class="location" style="width: 24%;"></div>-->
                    <!--                    <div class="event" style="width: 18%;"></div>-->
                </div>
            </div>
        </div>
        <div class="handbook-content__footer">
            <div class="handbook-content__footer__rowsCount">Количество записей: <span id="actualRowCount">0</span>
            </div>
            ...
            <div class="handbook-content__footer__show">
                ...
                <div class="handbook-content__footer__show__buttons">
                    <a class="show-pages-button">20</a><a class="show-pages-button">50</a><a class="show-pages-button">100</a><a
                            class="show-pages-button">200</a>
                </div>
            </div>
        </div>
    </div>
