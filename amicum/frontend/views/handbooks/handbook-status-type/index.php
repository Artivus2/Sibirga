...
$this->registerJsFile('/js/status-type.js', ['depends' => [AppAsset::className()],'position' => View::POS_END]);
...
$this->title = 'Справочник типов статусов';
?>
<!--Прелодер-->
...
<header class="header">
    ...
    <!--    <button class="addButton" id="addButton" title="Добавить новый тип статуса">-->
    <!--        Иконка добавления -->
    ...
    <div class="modal-dialog" role="document" style="margin-top: 8%;">
        ...
        <div class="modal-content no-padding">
            ...
            <div class="modal-header">
                <!-- Внутренности шапки -->
                <div class="add-header" style="left: 185px;">
                    <!-- Иконка добавления -->
                    <span class="icon-add-current-btn"></span>
                    <!-- Текст шапки -->
                    <span>Добавление типа статуса</span>
                </div>
...
<div id="editModal" class="modal fade" tabindex="-1" role="dialog" >
    ...
    <div class="modal-dialog" role="document" style="margin-top: 8%;">
        ...
        <div class="modal-content no-padding">
            ...
            <div class="modal-header">
                <!-- Внутренности шапки -->
                <div class="add-header" style="left: 170px;">
                    <!-- Иконка добавления -->
                    <span class="icon-edit-btn"></span>
                    <!-- Текст шапки -->
                    <span>Редактирование типа статуса</span>
                </div>
                <!-- Кнопка закрытия окна -->
                <button class="close close-x" data-dismiss="modal">&times;</button>
            </div>
        ...
        <div class="modal-content no-padding">
            ...
            <div class="modal-header">
                ...
                <div class="add-header" style="left: 200px;">
                    ...
                    <!-- Текст шапки -->
                    <span>Удаление типа статуса</span>
                </div>
                <!-- Кнопка закрытия окна -->
                <button class="close close-x" data-dismiss="modal">&times;</button>
            </div>
            ...
            <div class="modal-body delete-sensor-body">
                <!-- Текст модального окна -->
                <span class="delete-text">Вы действительно хотите удалить тип статуса:</span>
                <!-- Название датчика -->
...
<div class="col-xs-12 main-body" id="mainTableContainer">
    <div class="table-headers" id="mainTableHeader">
        ...
        <div class="col-xs-4 table-title table-header sort-field" data-field='name'  id="title" style="border-right: 1px solid #9e9e9e;" >Наименование<span class="glyphicon"></span></div>
        <div class="col-xs-7 table-ip table-header" id="trigger" style="border-right: 1px solid #9e9e9e;" ><span class="glyphicon"></span></div>
    </div>
