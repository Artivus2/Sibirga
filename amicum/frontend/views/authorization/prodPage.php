...
$files = scandir($_SERVER['DOCUMENT_ROOT']. "/web/authorization_prod");
...
foreach($files AS $file)
{
    ...
    {
        $this->registerJsFile('/authorization_prod/'.$file . '?ver=' . $version, ['depends' => [AppAsset::className()],'position' => View::POS_END]);
    }
}
