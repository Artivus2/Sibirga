...
/**
 * This is the model class for table "place_parameter_handbook_value".
 *
 * @property int $id
 ...
 */
class PlaceParameterHandbookValue extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'place_parameter_handbook_value';
    }
