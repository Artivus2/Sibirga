...
/**
 * This is the model class for table "equipment_parameter_value".
 *
 * @property int $id
 * @property int $equipment_parameter_id
 * @property string $date_time DATETIME(3)DATETIME(3)DATETIME(6)r
 ...
 */
class EquipmentParameterValue extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function attributeLabels()
    {
        return [
            ...
            'date_time' => 'DATETIME(3)DATETIME(3)DATETIME(6)r',
            'value' => 'Value',
            'status_id' => 'Status ID',
        ];
    }
