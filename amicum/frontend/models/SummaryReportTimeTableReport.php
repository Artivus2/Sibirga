...
/**
 * This is the model class for table "summary_report_time_table_report".
 *
 * @property int $id
 ...
 */
class SummaryReportTimeTableReport extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'summary_report_time_table_report';
    }
    ...
    public function rules()
    {
        return [
            [['date_time_work'], 'safe'],
            [['place_id', 'worker_id', 'type_place_id', 'kind_place_id', 'main_kind_place_id', 'department_id', 'place_status_id'], 'integer'],
