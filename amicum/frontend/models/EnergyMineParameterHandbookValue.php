...
/**
 * This is the model class for table "energy_mine_parameter_handbook_value".
 *
 * @property int $id
 ...
 */
class EnergyMineParameterHandbookValue extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'energy_mine_parameter_handbook_value';
    }
