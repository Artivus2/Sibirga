...
/**
 * This is the model class for table "work_mode_worker".
 *
 ...
 * @property string date_time_create дата создания режима работы
 * @property int $worker_id ключ компании, на который распространяется режим работы
 ...
 */
class WorkModeWorker extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['status_id', 'worker_id', 'work_mode_id', 'creater_worker_id'], 'integer'],
            [['date_time_start','date_time_create', 'worker_id', 'work_mode_id', 'creater_worker_id'], 'required'],
            [['date_time_start', 'date_time_end', 'date_time_create'], 'safe'],
            [['date_time_start', 'worker_id', 'work_mode_id'], 'unique', 'targetAttribute' => ['date_time_start', 'worker_id', 'work_mode_id']],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'worker_id' => 'ключ компании, на который распространяется режим работы',
