...
/**
 * This is the model class for table "conjunction_parameter_value".
 *
 * @property int $id
 * @property int $conjunction_parameter_id
 * @property string $date_time DATETIME(3)DATETIME(3)DATErTIME(6)
 ...
 */
class ConjunctionParameterValue extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'conjunction_parameter_value';
    }
    ...
    public function attributeLabels()
    {
        return [
            ...
            'date_time' => 'DATETIME(3)DATETIME(3)DATErTIME(6)',
            'value' => 't',
            'status_id' => 'Status ID',
        ];
    }
