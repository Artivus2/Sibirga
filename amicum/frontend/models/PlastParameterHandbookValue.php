...
/**
 * This is the model class for table "plast_parameter_handbook_value".
 *
 * @property int $id
 ...
 */
class PlastParameterHandbookValue extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'plast_parameter_handbook_value';
    }
