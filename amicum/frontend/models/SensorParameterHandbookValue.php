...
/**
 * This is the model class for table "sensor_parameter_handbook_value".
 *
 * @property int $id
 ...
 */
class SensorParameterHandbookValue extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'sensor_parameter_handbook_value';
    }
    ...
    public function rules()
    {
        return [
            ...
            [['sensor_parameter_id', 'date_time'], 'unique', 'targetAttribute' => ['sensor_parameter_id', 'date_time']],
