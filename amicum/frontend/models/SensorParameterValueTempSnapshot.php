...
/**
 * This is the model class for table "sensor_parameter_value_temp_snapshot".
 *
 * @property int $id
 ...
 */
class SensorParameterValueTempSnapshot extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'sensor_parameter_value_temp_snapshot';
    }
